  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <p>Budgets and milestone escrow can be priced in BNB (native) or in BEP-20 stablecoins USDT and USDC on BNB Smart Chain. The reference document and job listing set which token applies for that project.</p>
        ),
      },
    ],
  },
