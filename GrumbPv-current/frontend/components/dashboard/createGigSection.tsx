...
const CreateGigSection = () => {
    ...
    const [selectedPaymentSymbol, setSelectedPaymentSymbol] = useState<EscrowPaymentSymbol>("BNB");
    ...
    const handlePostGig = async () => {
        ...
        const gigPayload = {
            ...
            token_symbol: selectedPaymentSymbol,
    ...
    useEffect(() => {
        ...
        setSelectedPaymentSymbol(normalizeEscrowPaymentSymbol(editingGig.token_symbol));
    }, [editingGig]);
                ...
                <div className="linear-border rounded-lg p-0.25 linear-border--dark-hover">
                    <div className="linear-border__inner rounded-[0.4375rem] bg-white py-8 px-3 lg:p-8">
                        <div className='flex flex-col gap-6'>
                            ...
                            <div className="flex flex-col gap-2">
                                <p className="text-normal font-regular text-black text-left">Payment token</p>
                                <select
                                    value={selectedPaymentSymbol}
                                    onChange={(e) =>
                                        setSelectedPaymentSymbol(e.target.value as EscrowPaymentSymbol)
                                    }
                                    className="w-full appearance-none rounded-lg border border-[#8F99AF] bg-white p-3 text-normal font-regular text-black focus:outline-none focus:border-blue-500"
                                >
                                    {[...ESCROW_PAYMENT_SYMBOLS].map((sym) => (
                            ...
                            <div className="flex lg:flex-row flex-col gap-6">
                                <div>
                                    <p className='text-normal font-regular text-black text-left pb-2'>Max Budget ({selectedPaymentSymbol})</p>
                                    <input
                                        value={budgetMax}
                                        type="text"
                                        inputMode="decimal"
                                ...
                                <div>
                                    <p className='text-normal font-regular text-black text-left pb-2'>Min Budget ({selectedPaymentSymbol})</p>
                                    <input
                                        value={budgetMin}
                                        type="text"
                                        inputMode="decimal"
