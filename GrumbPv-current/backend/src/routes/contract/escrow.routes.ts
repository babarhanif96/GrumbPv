...
router.get(
  '/rewards/verify-infrastructure',
  escrowController.verifyRewardInfrastructure.bind(escrowController)
);
...
router.get(
  '/:job_milestone_id/rewards/expected',
  [param('job_milestone_id').isString().notEmpty()],
  validate([param('job_milestone_id')]),
  escrowController.getExpectedRewards.bind(escrowController)
);

router.post(
  '/:job_milestone_id/rewards/confirm',
  [param('job_milestone_id').isString().notEmpty(), body('txHash').isString().notEmpty()],
  validate([param('job_milestone_id'), body('txHash')]),
  escrowController.confirmWithdrawRewards.bind(escrowController)
);
