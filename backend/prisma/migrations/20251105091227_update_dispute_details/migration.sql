/*
  ...
  - The values [disputed] on the enum `milestone_status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "milestone_status_new" AS ENUM ('pending_fund', 'funded', 'delivered', 'approved', 'released', 'disputedWithoutCounterSide', 'disputedWithCounterSide', 'resolvedToBuyer', 'resolvedToVendor', 'cancelled');
